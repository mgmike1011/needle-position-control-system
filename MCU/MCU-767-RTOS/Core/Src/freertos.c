...
void StartSyringeControlTask(void *argument)
{
  /* USER CODE BEGIN StartSyringeControlTask */
	...
	A4988_Drive Syringe = { .NAME = "SYRINGE", .STEPS = 200, .RESOLUTION =
			HALF_STEP, .PORT_DIR = DIR_SYRINGE_GPIO_Port, .PIN_DIR =
			DIR_SYRINGE_Pin, .PORT_ENABLE = ENABLE_SYRINGE_GPIO_Port,
			.PIN_ENABLE = ENABLE_SYRINGE_Pin, .PORT_MS1 = MS1_SYRINGE_GPIO_Port,
			.PIN_MS1 = MS1_SYRINGE_Pin, .PORT_MS2 = MS2_SYRINGE_GPIO_Port,
			.PIN_MS2 = MS2_SYRINGE_Pin, .PORT_MS3 = MS3_SYRINGE_GPIO_Port,
			.PIN_MS3 = MS3_SYRINGE_Pin, .STEP_mm_RESOLUTION = 0.01,
			.PORT_RESET = RESET_SYRINGE_GPIO_Port, .PIN_RESET =
					RESET_SYRINGE_Pin, .PORT_SLEEP = SLEEP_SYRINGE_GPIO_Port,
			.PIN_SLEEP = SLEEP_SYRINGE_Pin, .TIM_STEP = &htim2,
			.TIM_STEP_CHANNEL = TIM_CHANNEL_1, .TIM_COUNTER_SLAVE = &htim3 };
...
void StartNeedleControlTask(void *argument)
{
  /* USER CODE BEGIN StartNeedleControlTask */
	...
	A4988_Drive Needle = { .NAME = "NEEDLE", .STEPS = 200, .RESOLUTION =
			HALF_STEP, .STEP_mm_RESOLUTION = 0.005, .PORT_DIR =
			DIR_NEEDLE_GPIO_Port, .PIN_DIR = DIR_NEEDLE_Pin, .PORT_ENABLE =
			ENABLE_NEEDLE_GPIO_Port, .PIN_ENABLE = ENABLE_NEEDLE_Pin,
			.PORT_MS1 = MS1_NEEDLE_GPIO_Port, .PIN_MS1 = MS1_NEEDLE_Pin,
			.PORT_MS2 = MS2_NEEDLE_GPIO_Port, .PIN_MS2 = MS2_NEEDLE_Pin,
			.PORT_MS3 = MS3_NEEDLE_GPIO_Port, .PIN_MS3 = MS3_NEEDLE_Pin,
			.PORT_RESET = RESET_NEEDLE_GPIO_Port, .PIN_RESET = RESET_NEEDLE_Pin,
			.PORT_SLEEP = SLEEP_NEEDLE_GPIO_Port, .PIN_SLEEP = SLEEP_NEEDLE_Pin,
			.TIM_STEP = &htim4, .TIM_STEP_CHANNEL = TIM_CHANNEL_1,
